# copied from http://github.com/typemytype/outlinerRoboFontExtension/blob/master/source/lib/outlinePen.py
...
def outlineGlyph(aGlyph,
    ...
    filterpen.drawSettings(drawOriginal=drawOriginal, drawInner=drawInner, drawOuter=drawOuter)
    aGlyph.clear()
    filterpen.draw(recorder)
